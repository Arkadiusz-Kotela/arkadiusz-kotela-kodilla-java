...
public class OrderFacade {
    ...
    public void processOrder(final OrderDto order, Long userId) throws OrderProcessingException {
        ...
        try {
            for (ItemDto orderedItem : order.getItems()) {
                LOGGER.info("Adding item " + orderedItem.getItemId() + ", " + orderedItem.getQuantity() + " pos");
                shopService.addItem(orderId, orderedItem.getItemId(), orderedItem.getQuantity());
            }
            ...
            LOGGER.info("Order verified and ready to be submitted");
